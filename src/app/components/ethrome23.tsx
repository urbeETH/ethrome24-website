...
export default function ETHRome23() {
  return (
    ...
    >
      ...
      <Marquee className="marquee_custom_container w-full px-6 py-3 xl:flex">
      ...
      <div className="w-full h-full flex justify-center items-center xl:justify-start xl:items-start ">
        <div className=" h-[calc(100%-35.19px)] xl:h-[calc(100%-107.19px)] flex flex-col justify-center items-center xl:pl-[33px] xl:py-8 gap-5">
          ...
          <div className="pt-5 md:pt-20 xl:pt-0">
      ...
      <div className="absolute left-0 w-full h-full flex flex-col justify-center items-center gap-20 xl:justify-start xl:items-start xl:flex-row xl:gap-0 xl:left-6">
        <div className="h-full flex flex-col justify-center items-center xl:pl-6 xl:pl-[33px] xl:py-8 gap-5 z-40 ">
          {ethrome23Numbers.map((item, index) => (
            <div
              key={index}
              className="flex flex-col justify-center items-center gap-2 ethrome23_number_box"
