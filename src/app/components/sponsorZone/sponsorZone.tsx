...
import { citizen, patrician } from "./sponsorsItems";
import Link from "next/link";

const marqueeItems = [
  { highlight: "40", rest: "selected builders" },
  { highlight: "11-13 September", rest: "2026" },
  { highlight: "Urbe Hub", rest: "Testaccio, Rome" },
];
      ...
      <div className="w-full pt-10 xl:pt-16 pb-[104px] xl:pb-[88px] flex flex-col justify-center items-start gap-10">
          ...
          <Marquee className="relative w-full flex justify-start items-center px-6 py-1 ">
            ...
            {Array.from({ length: 4 }).flatMap((_, repeat) =>
              marqueeItems.map((item, index) => (
                <div
                  key={`${repeat}-${index}`}
                  className="py-1 pr-4 flex justify-start items-center gap-4 text-base"
                >
        ...
        <div className="w-full flex flex-col justify-center items-center px-6 gap-10 2xl:px-20 2xl:items-start">
          <div className="w-full flex flex-col justify-center items-start gap-6 xl:flex-row">
            {/** Patrician */}
            <div className="w-full xl:w-2/3 flex flex-col justify-center items-start gap-4">
